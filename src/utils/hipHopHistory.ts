...
export const hipHopCulture: HipHopHistory[] = [
  ...
  {
    image: '',
    content: `Um termo que surgiu entre os breakdancers foi o A1 que significava que você era o melhor breakdancer do seu grupo, então se um b-boy mostrava ser melhor que o A1, ele era melhor que
    todos daquele grupo.`
  },
  {
